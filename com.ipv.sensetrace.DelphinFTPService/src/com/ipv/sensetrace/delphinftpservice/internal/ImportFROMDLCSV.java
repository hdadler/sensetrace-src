...
public class ImportFROMDLCSV {
	...
	public boolean FetchData(String ftplink, String dlid, String datefrom,
		...
		try {
			...
			// "/home/hendrik/missingdata/export_2013_09.csv")));
	...
	public void RemoveOldestFilesToBatch(String folder_str) {
		// actualfolder = folder_str;
		...
		for (int i = 0; i < SearchedFiles.size(); i++) {
			if (SearchedFiles.get(i).contains(date_str)) {
	...
	public boolean IsAllBatched(String folder_str) {
		...
		// Return true if folder contains less then two file
